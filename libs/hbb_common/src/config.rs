...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("YU-Destek".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["192.168.252.45"];
pub const RS_PUB_KEY: &str = "3moNQafkgKs189XBLsqpBuHLP2j4jhRxw9Sgd1WGImc=";
